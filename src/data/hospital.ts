...
export const testimonials = [
  {
    ...
    name: "Bahar Demir",
    role: "Hasta",
    text: "Etik Hastanesi’nde geçirdiğim tedavi sürecinden son derece memnun kaldım. Doktorlar çok ilgili ve hasta odaklıydı. Personel güler yüzlü ve yardımseverdi. Hastane temizliği de oldukça iyi düzeydeydi. Kesinlikle tavsiye ederim.",
  ...
  },
  {
    ...
    name: "Mustafa Ok",
    role: "Hasta",
    text: "Etik Hastanesi’nde yaşadığım deneyim beni çok etkiledi. Hemşireler ve doktorlar hastalara karşı olağanüstü bir empati gösterdi. Tedavi sürecimde her adımda bilgilendirildim ve rahat hissettim. Hastane ortamı da son derece konforluydu. Teşekkürler Etik Hastanesi.",
  ...
  },
  {
    ...
    name: "Neslihan Sert",
    role: "Hasta",
    text: "Etik Hastanesi’ne gitmeden önce endişelerim vardı ama gittiğimde tüm endişelerim dağıldı. Doktorlarımın profesyonelliği ve hastanenin modern tıbbi imkanlarıyla hızlıca teşhis ve tedavi sürecim başladı. Herkese Etik Hastanesi’ni öneririm.",
  ...
  },
  {
    ...
    name: "Ömer Küçük",
    role: "Hasta",
    text: "Etik Hastanesi’nde geçirdiğim tedavi sürecinden çok memnun kaldım. Doktorlarımız her zaman güler yüzlü ve anlayışlıydı. Tedavi sürecim boyunca her adımda bilgilendirildim ve desteklendim. Hastanenin hijyen standartları da oldukça yüksekti.",
